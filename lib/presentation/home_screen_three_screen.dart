...
class HomeScreenThreeScreen extends StatelessWidget {
                            ...
                            child: Row(
                              children: [
                                CustomIconButton(
                                  ...
                                  child: CustomImageView(
                                    imagePath:
                                        ImageConstant.imgUilMoneyWithdraw,
                                  ),
                                ),
                                Expanded(
                                  child: Padding(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildFrame(
                  context,
                  bonusBalanceText: "Wallet Balance",
                  nCounterText: "N 0.0",
                ),
                _buildFrame(
                  context,
                  bonusBalanceText: "Bonus Balance",
                  nCounterText: "N 0.0",
                ),
              ],
            ),
  ...
  Widget _buildFrame(
    ...
    required String bonusBalanceText,
    required String nCounterText,
  }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
