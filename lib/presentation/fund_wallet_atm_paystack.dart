...
import 'package:litepay/widgets/payment_unsuccessful.dart';
              ...
              CustomElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (_formKey2.currentState!.validate()){
                        ...
                        //Dialog box when payment is validated and successful
                        PaymentSuccessful(context); //code block for this function is below
                      }
                      else {
                        setState(() {
                          Navigator.of(context).pop();
                          ...
                          PaymentUnsuccessful(context); //code block for this function is found below
                        });
                      }
                    },
                  ),
