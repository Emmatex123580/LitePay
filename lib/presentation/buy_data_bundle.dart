...
class BuyDataBundle extends StatefulWidget {
  const BuyDataBundle({super.key});

  @override
  State<BuyDataBundle> createState() => _BuyDataBundleState();
}

class _BuyDataBundleState extends State<BuyDataBundle> {
  final _formKey = GlobalKey<FormState>();
  late TextEditingController network_provider = TextEditingController();//Controller for the Netwok provideer textfield
  late TextEditingController  data_type  = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: (network_provider.text == "") ? "Select Network" : network_provider.text,
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      controller: data_type,
                      keyboardType: TextInputType.number,
                      readOnly: true,
                      decoration: InputDecoration(
                        hintText: (data_type.text == "") ? "Data Type" : data_type.text,
                        contentPadding: EdgeInsets.all(10.0),
                        border: InputBorder.none,
                        suffixIcon: IconButton(        
                          icon:  Icon(Icons.arrow_drop_down_outlined),
  ...
  void _FingerPrintNotSet(BuildContext context) {
   ...
   // This function calls the botom sheet to select data type
  void _dataTypeBottomSheet(BuildContext context) {
    showModalBottomSheet(
      backgroundColor: Colors.white,
      context: context,
      isDismissible: true,
  ...
  //This function calls the bottom sheet to choose data plan
  void _dataPlanBottomSheet(BuildContext context) {
    showModalBottomSheet(
      backgroundColor: Colors.white,
      context: context,
      isDismissible: false,
